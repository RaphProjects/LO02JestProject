 ...
 * <p>
 * Permet de basculer facilement entre Console et Interface Graphique en fournissant
 * une API unique pour :
 * </p>
 * <ul>
 *   <li>la configuration (nombre de joueurs, type, stratégies, extension/variante)</li>
 *   <li>les menus (principal/pause)</li>
 *   <li>la gestion des sauvegardes</li>
 *   <li>les actions de jeu (offres, prises, confirmations, etc.)</li>
 * </ul>
 */
public interface IControleur {
     ...
     *
     * @return le nombre de joueurs choisi (typiquement 3 ou 4)
     */
     ...
     *
     * @return la chaîne entrée par l'utilisateur (selon l'implémentation)
     */
     ...
     * @return l'index de la carte choisie (0-based selon la spécification de cette méthode)
     */
     ...
     * @param carteVisibleNom nom de la carte visible ({@code null} si non disponible)
     * @param carteCacheeDisponible {@code true} si la carte cachée est disponible
    ...
    /**
     * Demande une confirmation avant une action importante.
     *
     ...
     *
     * @return {@code true} si le joueur veut nettoyer
     */
    ...
    /**
     * Ferme les ressources utilisées par le contrôleur (ex: Scanner) et/ou l'interface.
     */
    void fermer();
}